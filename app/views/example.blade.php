...
<div class="page-header">
    <h1>View Save Data <small>{{ $save->updated_at }}</small></h1>
</div>
<p class="lead text-info">Here's a quick list of your game stats:</p>
<table class="table">
    <thead>
    <th>Game Stats</th>
    </th>
    ...
    <tr>
        ...
        <td>{{ \Carbon\Carbon::now()->subMinutes(5)->toDayDateTimeString() }}</td>
    </tr>
    </tbody>
</table>
...
<p class="lead text-info">Here's a list of how many buildings of each type you have. </p>
...
<p class="lead text-info">Here's the raw game data. Just hover over it to select, then copy and paste into Cookie
    Clicker's save import box.</p>
