...
class SavesController extends BaseController {
    ...
    public function storeExternal()
    {
        ...
        return Response::view('bookmark.save', ['didSave' => $didSave], 200, [
            'Access-Control-Allow-Origin' => 'http://orteil.dashnet.org',
            'X-Frame-Options' => 'ALLOW-FROM http://orteil.dashnet.org'
        ]);
    }
